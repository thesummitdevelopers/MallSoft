...
public class Per_usuario extends javax.swing.JFrame {
    
    private String usuario;
    DefaultTableModel model = null;           
   
    public Per_usuario(String u) throws SQLException {
        usuario = u;
        setUndecorated(true);
        initComponents();
        cargarLista();
    ...
    public static void main(String u) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Per_usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Per_usuario(u).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Per_usuario.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
