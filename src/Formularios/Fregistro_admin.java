...
public class Fregistro_admin extends javax.swing.JFrame {
    
    private String usuario;
    
    public Fregistro_admin(String u) {
        usuario = u;
        setUndecorated(true);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnRegistrarse.setBounds(780, 550, 220, 90);
        ...
        btnAtras.setBounds(820, 650, 150, 80);
    ...
    public static void main(String u) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fregistro_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fregistro_admin(u).setVisible(true);
            }
        });
    }
